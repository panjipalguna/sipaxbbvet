...
class SiteController extends Controller
{
	...
	public function actionReport() {
		...
		$pdf = new Pdf([
			...
			'options' => ['title' => 'Sistem Pakar Penyakit Anjing dengan Certainty Factor'],
			'methods' => [
				'SetTitle' => 'SIPAN-Sistem Pakar Penyakit Anjing',
				'SetSubject' => 'Metode Certainty Factor',
				'SetHeader' => ['SIPAN - Balai Besar Kedokteran Hewan Unud|| Tanggal: ' . date("r")],
				'SetFooter' => ['|Halaman {PAGENO}|'],
				'SetAuthor' => 'SIPAN',
				'SetCreator' => 'SIPAN',
				'SetKeywords' => 'sipan, sistem pakar, certainty factor, drh_unud',
			]
		]);
