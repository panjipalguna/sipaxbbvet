...
<body class="fix-header card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						<?php if(!Yii::$app->user->isGuest && !empty(Yii::$app->session->get('level'))): ?>
							...
							<?php endif; ?>
							<?php if(Yii::$app->session->get('level')=='konsultasi'): ?>
								<li>
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Sistem Pakar Diagnosa Penyakit Anjing</li>
                        </ol>
                    </div>
            ...
            <footer class="footer">
                © Informatika Unud 2020 All Reserved Rights
