...
$this->title = 'SIPAN - Login';
$this->params['breadcrumbs'][] = $this->title;
?>
<h3 class="box-title m-b-20">LOGIN SIPAN</h3><hr>
    <?php $form = ActiveForm::begin([
		...
		<div class="form-group m-b-0">
			<div class="col-sm-12 text-center">
				<small><strong>PS Informatika FMIPA Unud</strong><br>
				Jl. Kampus Unud Bukit Jimbaran, Kuta Selatan, Badung, Indonesia
				</small>
				<br>
